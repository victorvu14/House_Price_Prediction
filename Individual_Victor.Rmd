...
Fron the graph above, we could see that 
...
As we can see the tenth first component explains almost 90% of the variation. So we will go ahead and experiment build a basic linear model with 10 components. 
