...
xgb1 <- xgb.train (params = mytune, data = dtrain, nrounds = xgbcv$best_iteration, watchlist = list(val=dtest,train=dtrain), print.every.n = 10, early.stop.round = 10, maximize = F , eval_metric = "mae")
...
xgb_final <- xgb.train(params = tune_final, data = train_df, nrounds = 100 , watchlist = list(val=test_df,train=train_df), print_every_n = 100, early_stopping_rounds = 10, maximize = F , eval_metric = "mae")
